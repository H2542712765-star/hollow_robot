...
def my_generate_move_group_launch(ld, moveit_config):
    ...
    move_group_configuration = {
        ...
        # Gazebo may report the final controller state slightly after the
        # nominal trajectory duration.  Keep monitoring enabled, but avoid
        # canceling a successful goal at that boundary.
